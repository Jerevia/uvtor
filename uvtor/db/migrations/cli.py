...
from uvtor.db.migrations.compat import string_types
...
def get_router(directory, database, verbose=0):
    ...
    from uvtor.db.migrations.compat import exec_in
    from uvtor.db.migrations.router import Router
...
@click.option('--directory', default='migrations',
              help="Directory where migrations are stored")
@click.option(
    '--fake',
    is_flag=True,
    default=False,
    help=("Run migration as fake."))
